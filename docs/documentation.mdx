...
Clarity doesn't have a formalized docblock standard. This package utilizes a standard proposed in [SIPS#32](https://github.com/stacksgov/sips/pull/32), along with implicit documentation standards used by existing Stacks contracts.
